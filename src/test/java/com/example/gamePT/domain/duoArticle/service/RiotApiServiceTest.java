...
public class RiotApiServiceTest {
    ...
    public void 경기정보가져오기() {
        MatchInfoDTO matchInfoDTO = this.riotApiService.getMatchInfo("KR_6963844384");
        String puuid = "SBudop6IA1ZkJ2UqCUBXA9jUsodp5LPmWsZZVjPxijznhhvDBF1lMJOEYUS0q65GjDRPXDcmD9zsmQ";
        ...
        System.out.printf(participantDTO.toString());
    }
}
